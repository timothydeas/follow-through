 ...
 *    after genuine use (a few check-ins), and is **never sentiment-gated**
...
object AppReview {
    ...
    private const val KEY_CHECKIN_COUNT = "checkin_count"
