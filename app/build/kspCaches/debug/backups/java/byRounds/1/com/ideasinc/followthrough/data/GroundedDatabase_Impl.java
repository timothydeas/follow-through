    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(23) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoNotes.equals(_existingNotes)) {
          return new RoomOpenHelper.ValidationResult(false, "notes(com.ideasinc.followthrough.data.GroundedNote).\n"
                  + " Expected:\n" + _infoNotes + "\n"
                  + " Found:\n" + _existingNotes);
        }
        ...
        if (!_infoFollowThroughs.equals(_existingFollowThroughs)) {
          return new RoomOpenHelper.ValidationResult(false, "follow_throughs(com.ideasinc.followthrough.data.FollowThroughEntry).\n"
                  + " Expected:\n" + _infoFollowThroughs + "\n"
        ...
        if (!_infoGoals.equals(_existingGoals)) {
          return new RoomOpenHelper.ValidationResult(false, "goals(com.ideasinc.followthrough.data.Goal).\n"
                  + " Expected:\n" + _infoGoals + "\n"
                  + " Found:\n" + _existingGoals);
        }
        ...
        if (!_infoCheckIns.equals(_existingCheckIns)) {
          return new RoomOpenHelper.ValidationResult(false, "check_ins(com.ideasinc.followthrough.data.CheckIn).\n"
                  + " Expected:\n" + _infoCheckIns + "\n"
                  + " Found:\n" + _existingCheckIns);
        }
        ...
        if (!_infoQuestionLabels.equals(_existingQuestionLabels)) {
          return new RoomOpenHelper.ValidationResult(false, "question_labels(com.ideasinc.followthrough.data.QuestionLabel).\n"
                  + " Expected:\n" + _infoQuestionLabels + "\n"
